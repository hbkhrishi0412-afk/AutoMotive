      ...
      <main style={{ padding: '2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.5rem 0' }}>✅ Website is Working!</h3>
            <p style={{ margin: 0 }}>
              The AutoMotive marketplace is successfully running. Database integration is ready and all features are available.
            </p>
          </div>
        </div>
      </main>
